...
public class OrderApplication {
  ...
  public static final String orderPlacedQueue = OrderPlacedEvent.class.getName();
  ...
  @Bean
  public Binding binding(@Qualifier("orderPlacedQueue") Queue queue, DirectExchange exchange) {
